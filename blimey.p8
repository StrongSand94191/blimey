...
if tab==1or tab==2and fruit_count==10or tab==3and max_djump==1then global"cansubmit=true"end
end
...
if lvl_id==14then global"max_djump,stopcounting,time_ticking=1,false,true"end
if fsid==1then
global"has_key=true"
end
